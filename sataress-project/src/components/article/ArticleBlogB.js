            ...
            <Grid container justify="center">
                ...
                <Card sx={{ maxWidth: 500, marginTop: 45,marginBottom:5 }}>
                    <CardContent>
                        ...
                        <br/>
                        <Typography variant="h7" color="text.primary" fontFamily='Roboto Slab, serif, Noto Sans Thai' style={{wordWrap:"break-word"}}>แหล่งที่มา https://manarom.com/blog/Stress_relief_at_your_desk.html</Typography>
                        <br/>
                        <br/>
                    </CardContent>
                </Card>
