  ...
  return (
    ...
    <div>
      ...
      <Dialog open={open} onClose={handleClose}>
          ...
          "ความรู้สึกขอบคุณ คือ ความรู้สึกที่ขอบคุณหรือยินดีกับประสบการณ์ที่เกิดขึ้นในชีวิต
          <br/>สิ่งที่ขอบคุณอาจจะเป็นเรื่องราวอะไรก็ได้ที่เกิดขึ้นในวันนี้ ที่เรารู้สึกขอบคุณหรือยินดี อาจจะเป็นเรื่องร้ายหรือเรื่องดีที่เราผ่านมันมาได้"
          </Typography>
          </DialogContent>
